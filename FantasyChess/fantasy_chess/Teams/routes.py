...
def my_team():
    ...
    return render_template('my_team', next_fixture=next_fixture, user_leagues=user_leagues, otb_team=current_user.otb_team, online_team=current_user.online_team)
