...
class User(db.Model, UserMixin):
    ...
    roles = db.Column(db.String(60), nullable=False, default='Civilian')
    ...
    online_team = db.relationship('Online_Team', backref='owner', uselist=False, cascade="all, delete")
    otb_team = db.relationship('OTB_Team', backref='owner', uselist=False, cascade="all, delete")

    historic_online_teams = db.relationship('Historic_Online_Teams', backref='owner', cascade="all, delete")
    historic_otb_team = db.relationship('Historic_OTB_Team', backref='owner', cascade="all, delete")
...
class Tournament(db.Model):
    ...
    league = db.relationship('League', backref='tournament', uselist=False)
...
class Article(db.Model):
    ...
    #Consider a table linking articles and tournaments/players 
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=False)
